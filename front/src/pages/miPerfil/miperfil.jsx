...
const MiPerfil = () => {
  ...
  useEffect(() => {
    ...
    const fetchImage = async () => {
      ...
      if (data.id) {
        ...
        try {
          const response = await fetch("https://vivacious-flexibility-production.up.railway.app/img/getImgByidUser", {
            method: "POST",
            headers: {
  ...
  const deleteUser = async () => {
    ...
    // try {
    //   const response = await fetch("https://vivacious-flexibility-production.up.railway.app/user/deleteUser", {
    //     method: "POST",
    //     headers: {
    //       "Content-Type": "application/json",
    //     },
